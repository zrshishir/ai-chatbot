...
namespace AiChatbot\Assets;

use AiChatbot\Core\Template;
use AiChatbot\Traits\Base;
use AiChatbot\Libs\Assets;

/**
 * Class Frontend
 *
 * Handles frontend functionalities for the AiChatbot.
 *
 * @package AiChatbot\Assets
 */
class Frontend {
